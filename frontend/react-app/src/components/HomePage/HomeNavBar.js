...
import logoIcon from "../../css/images/robinhood-icon.png";
...
const HomeNavBar = () => {
  ...
  return (
    <div className="home-nav-container" style={{ background: "black", color: "white" }}>
      ...
      <div className="home-search-bar-container" style={{ color: "black" }}>
      ...
      <div className="home-nav-links">
        ...
        {isClicked && (
          <div className="account-dropdown-container" style={{ color: "black" }}>
            <div className="logout-container" onClick={onLogout}><div className="logout-text">Logout</div></div>
            <div className="first-name-dropdown"><div className="first-name-text">{user.firstName} </div></div>
